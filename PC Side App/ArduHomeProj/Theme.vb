...
Class ReconButton1
    ...
    Overrides Sub PaintHook()
        Select Case MouseState
            Case State.MouseNone
                G.Clear(Color.FromArgb(49, 49, 49))
                DrawGradient(Color.FromArgb(220, 220, 220), Color.FromArgb(255, 255, 255), 1, 1, ClientRectangle.Width, ClientRectangle.Height, 270S)
                DrawBorders(Pens.SteelBlue, New Pen(Color.SteelBlue), ClientRectangle)
                DrawText(HorizontalAlignment.Center, Color.Navy, 0)
                DrawCorners(Me.BackColor, ClientRectangle)
            Case State.MouseDown
                G.Clear(Color.FromArgb(49, 49, 49))
                DrawGradient(Color.FromArgb(220, 220, 220), Color.FromArgb(176, 224, 230), 1, 1, ClientRectangle.Width, ClientRectangle.Height, 270S)
                DrawGradient(Color.FromArgb(100, 0, 0, 0), Color.Transparent, 1, 1, ClientRectangle.Width, ClientRectangle.Height / 2, 90S)
                DrawBorders(Pens.SteelBlue, New Pen(Color.SteelBlue), ClientRectangle)
                DrawText(HorizontalAlignment.Center, Color.Navy, 1)
                DrawCorners(Me.BackColor, ClientRectangle)
            Case State.MouseOver
                G.Clear(Color.FromArgb(49, 49, 49))
                DrawGradient(Color.FromArgb(220, 220, 220), Color.FromArgb(176, 224, 230), 1, 1, ClientRectangle.Width, ClientRectangle.Height, 270S)
